...
public class CategoryPickerUtil {
    ...
    public CategoryPickerUtil(PickerItemSelectListener listener) {
        mListener = listener;
    }
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                if (mListener != null) {
                    mListener.onCategoryPickerSelect(
                            options1Items1, options2Items1, options3Items1,
    ...
    public interface PickerItemSelectListener {
        ...
        void onCategoryPickerSelect(ArrayList<CategoryFirst> options1Items1,
