package com.bing.lan.comm.toast;
...
public class RxToast {
    ...
    @ColorInt
    private static final int ERROR_COLOR = AppUtil.getColor(R.color.colorPrimary);
    //private static final int ERROR_COLOR = Color.parseColor("#FD4C5B");

    @ColorInt
    private static final int INFO_COLOR = AppUtil.getColor(R.color.colorPrimary);
